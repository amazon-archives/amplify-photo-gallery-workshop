+++
title = "Allowing Other Users To View Albums"
chapter = false
weight = 20
+++
...
type Album 
  ...
  @auth(rules: [
    { allow: owner }
    { allow: owner, ownerField: "members", queries: [get, list] }
  ]) {
    id: ID!
    name: String!
    owner: String
...
{{< highlight jsx "hl_lines=6 49-58 64-65 370-383 432-439 490-556">}}
...
- Imported *Icon* from semantic-ui-react
...
- Created an AddUsernameToAlbum component and an AlbumMembers component to handle adding and listing album members


### Try out the app

To test out our new multi-user capabilities, we'll need at least one other user to invite to an album. Sign out of the app and create a new user (don't forget to check the email and submit the validation code). Then, sign out and back in using your original username. Navigate to an album you'd like to share and invite your new username to the album. Then sign back in with the new username and you'll see the album listed!